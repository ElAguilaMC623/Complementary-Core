...
public class TieredWeaponBuilder {
    ...
    private Function<Item.Properties, Item.Properties> propertiesModifier = p -> p;

    public TieredWeaponBuilder properties(Function<Item.Properties, Item.Properties> modifier) {
    ...
    public void register() {
        for (var entry : factories.entrySet()) {
            ...
            RegistryObject<Item> item = register.register(
                    name,
                    () -> {
                        Item.Properties props = propertiesModifier.apply(new Item.Properties());
                        return factory.create(tier, props);
                    }
            );
