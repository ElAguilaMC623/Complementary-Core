...
public class ArmorSetBuilder {
    ...
    public ArmorSetBuilder helmet() {
        this.helmetFactory = (m, p) -> new ArmorItem(m, EquipmentSlot.HEAD, p);
        return this;
    }

    public ArmorSetBuilder chestplate() {
        this.chestplateFactory = (m, p) -> new ArmorItem(m, EquipmentSlot.CHEST, p);
        return this;
    }

    public ArmorSetBuilder leggings() {
        this.leggingsFactory = (m, p) -> new ArmorItem(m, EquipmentSlot.LEGS, p);
        return this;
    }

    public ArmorSetBuilder boots() {
        this.bootsFactory = (m, p) -> new ArmorItem(m, EquipmentSlot.FEET, p);
        return this;
    }
