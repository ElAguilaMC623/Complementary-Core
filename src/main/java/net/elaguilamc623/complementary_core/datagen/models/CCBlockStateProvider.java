...
public abstract class CCBlockStateProvider extends BlockStateProvider {
    ...
    public CCBlockStateProvider(DataGenerator generator,
                                String modId,
    ...
    protected void trapdoor(RegistryObject<Block> trapdoor,
                            boolean orientable,
                            String renderType) {
    ...
    protected void axis(RegistryObject<Block> block,
    ...
    protected void leaves(RegistryObject<Block> leaves) {
        ...
        simpleBlock(leaves.get(), model);
        simpleBlockItem(leaves.get(), model);
    }
